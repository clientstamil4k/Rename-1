...
async def start(client, message):
    ...
    button=InlineKeyboardMarkup([[
        InlineKeyboardButton('📢 𝚄𝙿𝙳𝙰𝚃𝙴𝚂', url='https://t.me/Movies_Unfold')
        ],[
        InlineKeyboardButton('🍂 Dubbed Anime Channel', url='https://t.me/Ongoing_Dub_Anime')
        ],[
...
async def cb_handler(client, query: CallbackQuery):
    ...
    if data == "start":
        ...
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup( [[
               InlineKeyboardButton("❣️ 𝚂𝙾𝚄𝚁𝙲𝙴 **PAID**", url="https://t.me/Anos_AU")
               ],[
